...
static constexpr auto qt_meta_stringdata_ZN13AddItemDialogE = QtMocHelpers::stringData(
    "AddItemDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13AddItemDialogE[] = {
...
Q_CONSTINIT const QMetaObject AddItemDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13AddItemDialogE.offsetsAndSizes,
    qt_meta_data_ZN13AddItemDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13AddItemDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *AddItemDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13AddItemDialogE.stringdata0))
